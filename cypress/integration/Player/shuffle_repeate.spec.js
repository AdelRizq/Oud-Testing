...
describe('Shuffle/Repeat', () => {
    ...
    it('shuffle Button', () => {
        cy.wait(1000);
        cy.get(`[data-testid='${self.playerIds.shuffle}']`).click().then((shuffle) => {
    ...
    it('repeate Button', () => {
        cy.wait(1000);
        cy.get(`[data-testid='${self.playerIds.repeate}']`).click().then((repeate) => {
            cy.get(`[data-testid='${self.playerIds.trackName}']`).then((trackName) => {
                let tName = trackName.text();
                cy.get(`[data-testid='${self.playerIds.progressBar}']`).click('right').then(() => {
