...
public class OudHomeTest extends BaseClass {
    ...
    public void Home() {
        ...
        boolean fail = false;
        // Changing the playlist without changing the route this test for test the
        // frontend ..
        ...
        back();
        // Changing the playlist then change the route and go the the playlist again and
        // check its name this test for the backend ..
    ...
    public void CheckAccount() {
        ...
        // changing the Account Name by two methods the first method by the pen icon
        // after the Name of hte account
